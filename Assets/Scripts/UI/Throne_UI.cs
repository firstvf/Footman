...
public class Throne_UI : MonoBehaviour
{
    ...
    {
        if (_greenTeam != null && _throne.Length - 1 > CurrentThroneLevel 
            && _playersEconomy.GreenTeamMoney >= 150 && _playersEconomy.GreenTeamWood >= 15 && _playersEconomy.GreenTeamIron >= 15)
        {
            _playersEconomy.WithdrawRecourcesGreenTeam(150, 15, 15);
            StartCoroutine(UpgradeCasle());
        }

        if (_redTeam != null && _throne.Length - 1 > CurrentThroneLevel 
            && _playersEconomy.RedTeamMoney >= 150 && _playersEconomy.RedTeamWood >= 15 && _playersEconomy.RedTeamIron >= 15)
        {
    ...
    public void BuySmithy()
    {
        ...
        if (_redTeam != null&&!_smithy.GetComponent<Smithy>().IsBuild )//&& _playersEconomy.RedTeamMoney >= 50 && _playersEconomy.RedTeamWood >= 5 && _playersEconomy.RedTeamIron >= 5)
        {
